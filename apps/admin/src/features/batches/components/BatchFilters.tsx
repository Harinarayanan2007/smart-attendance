...
export function BatchFilterControls({ filters, onChange }: BatchFiltersProps) {
            ...
            <div className="flex items-center gap-2">
                ...
                <select
                    ...
                    onChange={(e) => {
                        onChange({
                            ...filters,
                            sort: e.target.value as BatchFilters['sort'],
                            page: 1,
                        });
                    }}
                >
                    ...
                    <option value="endYear">Sort by End Year</option>
